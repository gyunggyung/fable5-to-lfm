...
# DiffusionGemma Fabliq/Hermes LoRA smoke runner.
# Dry-run by default:
#   bash fable_distillation/scripts/run_diffusiongemma_fable_lora_20260624.sh
# Actual run after GPUs are free:
#   RUN_NOW=1 bash fable_distillation/scripts/run_diffusiongemma_fable_lora_20260624.sh
...
RUN_NOW="${RUN_NOW:-0}"
RUN_ID="${RUN_ID:-20260624_diffusiongemma_fable_agent_lora_smoke}"
...
CONFIG_PATH="${CONFIG_PATH:-$FABLE_DIR/configs/diffusiongemma_26b_a4b_fable_agent_lora_smoke_20260624.yaml}"
