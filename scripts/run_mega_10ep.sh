#!/usr/bin/env bash
# Mega 10ep - 10 epoch ablation (LR 낮춰 overfitting 방지)
set -euo pipefail
cd /home/work/.projects/LLM-OS-Models/Terminal
OUTPUT_DIR=/home/work/.data/harness1/models/LFM2.5-8B-A1B__Terminal-Mega-10ep-FullSFT-20260623 \
  ...
  .liquid-sft-env/bin/python -m torch.distributed.run --standalone --nproc_per_node=8 \
    ...
    --output-dir /home/work/.data/harness1/models/LFM2.5-8B-A1B__Terminal-Mega-10ep-FullSFT-20260623 \
    --finetune-mode full --max-seq-length 8192 --epochs 10 --learning-rate 5e-7 \
